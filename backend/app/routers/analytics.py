...
async def get_dashboard_stats(
    ...
    # Get all metrics
    trans_summary = await get_transactions_summary(7, db, current_user)
    user_growth = await get_user_growth(30, db, current_user)
    fraud_metrics = await get_fraud_metrics(7, db, current_user)
